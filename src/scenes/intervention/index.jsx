...
const Intervention = () => {
  ...
  useEffect(() => {
    const fetchInterventions = async () => {
      try {
        const { data } = await axios.get(`https://nodeappectt.onrender.com/api/interventions/search?search=${search}`);
  ...
  const handleAddIntervention = async (values) => {
    try {
      const response = await axios.post('https://nodeappectt.onrender.com/api/interventions', values);
